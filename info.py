...
PICS = (environ.get('PICS', 'https://pixabay.com/images/download/x-3696006_1920.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6107651667').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6107651667').split()]  # For Multiple Id Use One Space Between Each.
